...
public class tradeList {
	...
	/**
	 * Gets the d trading sym.
	 *
	 * @return the d trading sym
	 */
	public String getdTradingSym() {
		return dTradingSym;
	}
	
	/**
	 * Sets the d trading sym.
	 *
	 * @param dTradingSym the new d trading sym
	 */
	public void setdTradingSym(String dTradingSym) {
		this.dTradingSym = dTradingSym;
	}
	
	/**
	 * Gets the disclosed quantity.
	 *
	 * @return the disclosed quantity
	 */
	 ...
	 *
	 * @param disclosedQuantity the new disclosed quantity
	 */
	 ...
	 *
	 * @param displayPrice the new display price
	 */
	 ...
	 *
	 * @param displayQuantity the new display quantity
	 */
	 ...
	 *
	 * @param executionPrice the new execution price
	 */
	...
	/**
	 * Gets the checks if is AMO.
	 *
	 * @return the checks if is AMO
	 */
	...
	/**
	 * Sets the checks if is AMO.
	 *
	 * @param isAMO the new checks if is AMO
	 */
	public void setIsAMO(String isAMO) {
		this.isAMO = isAMO;
	}
	...
	/**
	 * Gets the checks if is tradable.
	 *
	 * @return the checks if is tradable
	 */
	...
	/**
	 * Sets the checks if is tradable.
	 *
	 * @param isTradable the new checks if is tradable
	 */
	 ...
	 * Sets the marketlot.
	 *
	 * @param marketlot the new marketlot
	 */
	 ...
	 *
	 * @param tradingSymbol the new trading symbol
	 */
